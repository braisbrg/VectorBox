...
export function MoreLikeThis({}: MoreLikeThisProps) {
    ...
    const searchMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            setSearchResults(
                data.reduce((acc: SearchedMovie[], m: { tmdb_id: number; title: string; year?: number; poster_path?: string; overview?: string }) => {
    ...
    return (
        <div className="space-y-6">
            <div className="text-center mb-8">
                <h2 className="text-3xl font-semibold mb-2">More Like This</h2>
            ...
            {seedMovies.length === 0 && !searchMutation.isPending && searchResults.length === 0 && (
                <div className="text-center py-12 text-muted-foreground">
                    <Film className="size-16 mx-auto mb-4 opacity-50" />
