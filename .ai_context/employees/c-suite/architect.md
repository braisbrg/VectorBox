...
- **Models Cache**: The `models_cache` volume is REQUIREMENT for model persistence.
...
- **Metadata Recovery (v1.4):** Enrichment MUST be re-triggered for movies missing critical external ratings (IMDb), even if already scored.
