...
- K-Medoids clustering of the user's watched films (semantic actual films rather than abstract centroids)
- Dynamic cluster labels generated by LLMs via Groq
- Dynamic K selection based on library size
- Recency bias: recent watches weighted higher in medoid computation
